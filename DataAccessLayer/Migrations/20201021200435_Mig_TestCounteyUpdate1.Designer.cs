...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20201021200435_Mig_TestCounteyUpdate1")]
    partial class Mig_TestCounteyUpdate1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.TestCountry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.Test", b =>
                {
                    ...
                    b.HasOne("DataAccessLayer.Entities.User", "User")
                        .WithOne("Test")
                        .HasForeignKey("DataAccessLayer.Entities.Test", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.TestCountry", b =>
                {
                    b.HasOne("DataAccessLayer.Entities.Country", null)
                        .WithMany("TestCountries")
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("DataAccessLayer.Entities.Test", null)
                        .WithMany("TestCountries")
